...
variants, complete factory identities, and the sensor catalog. The older
`20251231` release is retained as a historical snapshot; see the
[migration notes](CHANGELOG.md#100---2026-09-21) when upgrading from it.
